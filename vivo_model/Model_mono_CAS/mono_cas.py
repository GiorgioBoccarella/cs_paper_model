...
for s in range(1, 101):
    ...
    for k in range(1, length_experiment):
        ...
        if k % 24 == 0 or k == 0:
            B += 6 # Application of antibiotic A
        else:
...
csv_data.to_csv('mono_multi_cas.csv', mode='w', index=False)
...
csv_data.to_csv('dynamic_mono_cas.csv', mode='w', index=False)
